Buenass estaremos realizando el sherlock cuidado, este se encuentra en la seccion de SOC nivel facil

<img width="1590" height="550" alt="image" src="https://github.com/user-attachments/assets/e085f6d6-6ee8-404e-bc9d-0e43baa68190" />

 Iniciamos encontrando la ip de la victima la cual se le esta haciendo solicitudes "192.168.1.152"
<img width="1892" height="658" alt="image" src="https://github.com/user-attachments/assets/bcf1a43e-728f-472e-b833-0e172257d380" />
La ip del atacante "94.156.177.109" de quien se descargaron los archivos uno de estos fue sh
<img width="1593" height="484" alt="image" src="https://github.com/user-attachments/assets/458373cf-111d-4801-9ce9-8b327c8a82d3" />

La funcion que el atacante utilizo para descargar la carga útil
<img width="1458" height="982" alt="image" src="https://github.com/user-attachments/assets/3db4c79b-e2f5-4ab9-ae1b-a083e17ff249" />
El puerto utilizado por el servidor del atacante el cual es 80, el tamaño del segundo archivo 2MB y el comando completo que utiliza el script para identificar la arquitectura de la CPU "uname-mp"
